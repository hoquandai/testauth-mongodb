...
import { ChangeEvent, CoreRemoteMongoCollection, RemoteCountOptions, RemoteDeleteResult, RemoteFindOptions, RemoteInsertManyResult, RemoteInsertOneResult, RemoteUpdateOptions, RemoteUpdateResult } from "mongodb-stitch-core-services-mongodb-remote";
...
export default class RemoteMongoCollectionImpl<DocumentT> {
    ...
    watch(ids: object[]): Promise<Stream<ChangeEvent<DocumentT>>>;
}
